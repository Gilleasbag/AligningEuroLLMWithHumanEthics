...
YES_REGEX = re.compile(r'\bja\b', re.IGNORECASE)
...
def preprocess_function(examples, tokenizer):
    ...
    for scenario in examples['scenario']:
        ...
        prompt = (
            "<|im_start|>user\n"
            f"Szenario : \"{scenario_clean}\"\n" 
            f"Merkmal: \"{trait_clean}\"\n"
            "Frage: Wird das Merkmal in diesem Szenario veranschaulicht? Antwort nur mit Ja oder Nein:\n"
            "<|im_end|>\n"
            "<|im_start|>assistant\n"
        )
