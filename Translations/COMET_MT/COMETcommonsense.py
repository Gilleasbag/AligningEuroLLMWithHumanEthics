...
def load_datasets_with_hf(source_path, translation_paths, num_entries=None):
    ...
    for lang, path in translation_paths.items():
        ...
        translations = translated_dataset['input']
...
def main():
    # Define file paths
    source_csv = 'English_Datasets/commonsense.csv'
    translation_csvs = {
        'fr': 'Translations/OPUS_MT/Datasets/Combined/translation_results_commonsense_opus_mt_fr_20250116-170014.csv',
        'de': 'Translations/OPUS_MT/Datasets/Combined/translation_results_commonsense_opus_mt_de_20250116-182359.csv',
        'es': 'Translations/OPUS_MT/Datasets/Combined/translation_results_commonsense_opus_mt_es_20250116-154922.csv'
    }
