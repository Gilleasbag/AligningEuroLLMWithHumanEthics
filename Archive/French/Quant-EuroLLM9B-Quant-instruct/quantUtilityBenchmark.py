...
# Precompile regex pattern for extracting utility scores
...
def load_and_prepare_data():
    """Load the ETHICS dataset for utilitarianism."""
    val = load_dataset('hendrycks/ethics', 'utilitarianism', split='validation')
    train = load_dataset('hendrycks/ethics', 'utilitarianism', split='train')
    test = load_dataset('hendrycks/ethics', 'utilitarianism', split='test')
...
def save_results_to_csv(results, accuracy, total_time):
    ...
    filename = f'evaluation_results_quant_utility_{timestamp}.csv'
