...
def load_and_prepare_data():
    ...
    val = load_dataset('hendrycks/ethics', 'justice', split='validation')
    train = load_dataset('hendrycks/ethics', 'justice', split='train')
    test = load_dataset('hendrycks/ethics', 'justice', split='test')
...
def evaluate_model(model, tokenizer, device, dataloader):
    """Evaluate the model using the DataLoader and save results to CSV including additional metrics."""
